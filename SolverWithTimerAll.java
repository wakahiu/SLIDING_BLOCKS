...
public class SolverWithTimerAll{
	...
	public static boolean search(){
		...
		if(currentMove==null){
			...
			Iterator<Block> goalBlocks = goalConfig.iterator();
			HashSet<Block> currentBlocks = myBoard.getTray();
			boolean out = true;
			while(goalBlocks.hasNext()){
				out &= currentBlocks.contains(goalBlocks.next());
			}
	...
	public static void main (String[] args){
		...
		initial.add("testing/hard/handout.config.2");
		initial.add("testing/hard/century+180");
		initial.add("testing/hard/pandemonium");
		initial.add("testing/hard/big.tray.1");
		initial.add("testing/hard/big.tray.3");
		initial.add("testing/hard/c22");
		initial.add("testing/hard/c25");
		initial.add("testing/hard/c26");
		initial.add("testing/hard/c43-45");
		initial.add("testing/hard/c46");
		initial.add("testing/hard/c53");
		initial.add("testing/hard/c54");
		initial.add("testing/hard/c55");
		initial.add("testing/hard/c64");
		initial.add("testing/hard/supercompo");
		initial.add("testing/hard/lane.rouge");
		initial.add("testing/hard/d209");
		initial.add("testing/hard/little.house");
		initial.add("testing/hard/super.century");
		
		goals.add("testing/hard/goal.1.from.handout");
		goals.add("testing/hard/century+180.goal");
		goals.add("testing/hard/pandemonium.goal");
		goals.add("testing/hard/big.tray.1.goal");
		goals.add("testing/hard/big.tray.3.goal");
		goals.add("testing/hard/22.goal");
		goals.add("testing/hard/15.23-27.30.41.goal");
		goals.add("testing/hard/15.23-27.30.41.goal");
		goals.add("testing/hard/45.goal");
		goals.add("testing/hard/46.goal");
		goals.add("testing/hard/53.54.64.goal");
		goals.add("testing/hard/53.54.64.goal");
		goals.add("testing/hard/55.56.goal");
		goals.add("testing/hard/53.54.64.goal");
		goals.add("testing/hard/supercompo.goal");
		goals.add("testing/hard/lane.rouge.goal");
		goals.add("testing/hard/d209.goal");
		goals.add("testing/hard/little.house.goal");
		goals.add("testing/hard/super.century.goal");
		
		for(int i = 0; i<initial.size(); i++){
			
			myBoard = null;
			myTrie = new MoveTrie(); //Pointer to this moves around as we traverse,
			//but we don't lose track of parents due to myParent
			fringe = new Stack<MoveTrie>();
			deadEnds = new HashSet<HashSet<Block>>();
			alreadySeen = new HashSet<HashSet<Block>>();
			goalConfig = new HashSet<Block>();
			numGoals = 0;
			...
			try {
				initConditions = new Scanner(new File(initial.get(i)));
			...
			try {
				goalList = new Scanner(new File(goals.get(i)));
			} catch (FileNotFoundException e) {
				System.out.println(e);
			}
