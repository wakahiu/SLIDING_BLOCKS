...
public class SolverWithAllMoves{
	...
	public static boolean search(){
		...
		if(currentMove==null){
			...
			while(myTrie!=nextNode.getParent()){
				...
				System.out.println(parentMove.getEndR()+" "+parentMove.getEndC()+" "+parentMove.getStartR()+" "+parentMove.getStartC());
			...
			//Apply currentMove
			System.out.println(currentMove.getStartR()+" "+currentMove.getStartC()+" "+currentMove.getEndR()+" "+currentMove.getEndC());
			...
			if(deadEnds.contains(myBoard.getTray())||alreadySeen.contains(myBoard.getTray())){
				System.out.println(currentMove.getEndR()+" "+currentMove.getEndC()+" "+currentMove.getStartR()+" "+currentMove.getStartC());
				myBoard.move(currentMove.getMoveLength(),currentMove.getMoveWidth(),
						currentMove.getEndR(),currentMove.getEndC(),
						currentMove.getStartR(),currentMove.getStartC(),
						currentMove.getNumMatchGoal());
